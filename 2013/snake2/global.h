...
public:
	...
	void MsgBox(){MessageBox(NULL,info.c_str(),"错误",MB_OK);}
};
...
//-------------------Enums--------------------------------
enum ANITYPE{ANI_LOGO=0,ANI_MENUBK,ANI_SNAKE_HEAD,ANI_SNAKE_BODY,ANI_SNAKE_TAIL,ANI_FOOD,ANI_BACKGROUND,
...
enum ANIBUTTON{ANI_BUTTON_NEW,ANI_BUTTON_OLD,ANI_BUTTON_SEL,ANI_BUTTON_HELP,ANI_BUTTON_QUIT,
